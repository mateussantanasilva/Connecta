                    ...
                    <table className="min-w-full table-fixed border-collapse border border-zinc-300 rounded-lg">
                        <thead>
                            <tr className="bg-zinc-100">
                                <th className="border border-zinc-300 px-4 py-2 text-left">Doador</th>
                                <th className="border border-zinc-300 px-4 py-2 text-left">Campanha</th>
                                <th className="border border-zinc-300 px-4 py-2 text-left">Item</th>
                                <th className="border border-zinc-300 px-4 py-2 text-left">Pendente há</th>
                                <th className="border border-zinc-300 px-4 py-2 text-left">Ações</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr className="border-b">
                                <td className="border border-zinc-300 px-4 py-2">
                                    <div className="flex items-center gap-2">
                                        ...
                                        <Avatar className="flex items-center gap-2 border border-zinc-300 bg-transparent p-2 rounded-md hover:bg-zinc-100"
                                ...
                                <td className="border border-zinc-300 px-4 py-2">Multirão de Natal</td>
                                <td className="border border-zinc-300 px-4 py-2">Pacote de arroz<br />
                                    3kg
                                </td>
                                <td className="border border-zinc-300 px-4 py-2">há cerca de 2 meses</td>
                                <td className="border border-zinc-300 px-4 py-2">
                                    <div className="flex items-center gap-2">
                            ...
                            <tr className="border-b">
                                ...
                                <td className="border border-zinc-300 px-4 py-2">Multirão de ano novo</td>
                                <td className="border border-zinc-300 px-4 py-2">Pacote de feijão<br />
                                    2kg
                                </td>
                                <td className="border border-zinc-300 px-4 py-2">há cerca de 9 meses</td>
                                <td className="border border-zinc-300 px-4 py-2">
                                    <div className="flex items-center gap-2">
                                        <Button size="xs" variant="danger">
                                            <X className="size-5 shrink-0" />
